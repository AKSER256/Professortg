...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('📢 Uᴩᴅᴀᴛᴇꜱ 📢', url=f'https://t.me/Airdrop_Glow')
            ],[
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("🛠️ My Oᴡɴᴇʀ", url="https://t.me/Prime_Aigo")
            ],[      
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        try:
            ...
            return
        btn = [[InlineKeyboardButton("🎗️ Rᴇqᴜᴇꜱᴛ Tᴏ Jᴏɪɴ Mʏ Cʜᴀɴɴᴇʟ 🎗️", url=invite_link.invite_link)]]
